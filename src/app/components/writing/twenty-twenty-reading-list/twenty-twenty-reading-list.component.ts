  ...
  ngOnInit(): void {
    this.books = [
      ...
      },
      {
        ...
        "score": "👶 ➡️ 👨",
        "myThoughts": "Initially it felt like this book made a lot of sense. But after giving it some time, I feel like it falls into a similar camp of the Meyer's Briggs or Enneagram of Personality. It seems like a potentially useful tool for psychotherapists but I'm hesitant to self-assign labels. I don't want to feel like one attachment style defines me and inhibit my personal development. As far as theories go, it at least felt well founded.",
      ...
      },
      {
        ...
        "score": "🍯🍯🍯🍯🍯🍯🍯🍯🍯🍯",
        "myThoughts": "An amazing look at how Winnie the Pooh is the ideal Taoist. Even reading 5 pages of this book filled me with calm. I will probably read it again in the future to remind myself of Dào. It ends at the Enchanted Place at the top of the forest. \"To get there, just take the path to Nothing and go Nowhere until you reach it. Because the Enchanted Place is right where you are, and if you're Friendly With Bears, you can find it.\"",
      ...
      },
      {
        ...
        "myThoughts": "It was a short page turner so I didn't mind it too much. The action was decent, but I felt like they spent too much time describing characters I'll never see again. I will probably not be continuing emersion into the Murderbot universe.",
      ...
      },
      {
        ...
        "wir": "After two failed long-term relationships I felt it was time to get to the bottom of why I'm so gosh dang bad at them. This one was on Mark Manson's top 5 relationships book list.",
      ...
      },
      {
        ...
        "wir": "I was recommended this book along with The Night Circus (which was phenomenal!) while drunk on scotch at one of my best friend's wedding.",
        "score": "🔥🔥🔥",
      ...
      },
      {
        ...
        "score": "1 \"New Magnolia\" State Flag (may it pass legislative approval)",
