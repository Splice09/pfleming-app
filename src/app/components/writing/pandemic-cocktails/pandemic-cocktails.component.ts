...
@Component({
  selector: 'pandemic-cocktails',
  templateUrl: './pandemic-cocktails.component.html',
  styleUrls: ['./pandemic-cocktails.component.scss']
})
export class PandemicCocktailsComponent implements OnInit {
  books;
  constructor() { }
    ...
    this.books = [
      {
        ...
        "cover": "app/components/writing/pandemic-cocktails/cocktails/aviation.jpg"
      },
      {
        "title": "Bees Knees",
        ...
        "cover": "app/components/writing/pandemic-cocktails/cocktails/beesKnees.jpg"
      },
      {
        "title": "Boulevardier",
        "author": "Mel Robbins",
        ...
        "cover": "app/components/writing/pandemic-cocktails/cocktails/boulevardier.jpeg"
      },
      {
        "title": "Eggnog",
        ...
        "cover": "app/components/writing/pandemic-cocktails/cocktails/eggNog.jpg"
      },
      {
        "title": "French 75",
        ...
        "cover": "app/components/writing/pandemic-cocktails/cocktails/french75.jpeg"
      },
      {
        "title": "Gin and Tonic",
        "author": "Martha Wells",
        ...
        "cover": "app/components/writing/pandemic-cocktails/cocktails/ginAndTonic.jpg"
      },
      {
        "title": "Junglebird",
        ...
        "cover": "app/components/writing/pandemic-cocktails/cocktails/junglebird.jpg"
      },
      {
        "title": "Margarita",
        ...
        "cover": "app/components/writing/pandemic-cocktails/cocktails/margarita.jpeg"
      },
      {
        "title": "New York Sour",
        "author": "Brandon Sanderson",
        ...
        "cover": "app/components/writing/pandemic-cocktails/cocktails/newYorkSour.jpg"
      },
      {
        "title": "Paloma",
        "author": "John Grisham",
        ...
        "cover": "app/components/writing/pandemic-cocktails/cocktails/paloma.jpeg"
      },
      {
        "title": "Vodka Raspberry Sour",
        "author": "John Grisham",
        "wir": "One of my favorite neighbors was reading it on his porch and let me borrow it.",
        "score": "1 \"New Magnolia\" Mississippi State Flag (may it pass legislative approval)",
        "myThoughts": "First and foremost this collection of short stories reads like an airport page turner. However, I have continuously been impressed at how well Grisham is able to connect me with characters in a mere 50 pages per short story. He keeps the character list simple and paints scenes really well.",
        "cover": "app/components/writing/pandemic-cocktails/cocktails/vodkaRaspberrySour.jpg"
      }
    ]
  }
